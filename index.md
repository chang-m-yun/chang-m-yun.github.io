...
- __User-friendly resources__:
  - Models on: [__Hugging Face__](https://huggingface.co/collections/kundajelab/encode-bpnet-models) 
  - Tracks on: [__UCSC Genome Browser__](https://genome.ucsc.edu/cgi-bin/hgTracks?db=hg38&hubUrl=https://kundajelab.github.io/ucsc-trackhub-encode.github.io/hub.txt)
  - All resources on: [__ENCODE Portal__](https://encodeproject.org/search/?type=Annotation&annotation_type=BPNet-model&annotation_type=ChromBPNet-model&status=released)
